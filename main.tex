...
Most file formats are intended as immutable artifacts: if you want a new version of the data, you write a new file. In HEP, we usually {\it use} data that way.
