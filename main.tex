...
\textcolor{gray}{Incidentally, parallel reading and writing are unsung features of memory-mapping: no mutable state introduced by the file pointer. Many thread-local pointers read from different parts of the virtual address space.}
\end{frame}
